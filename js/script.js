...
function updateEmail(emailClass) {
    ...
    $.post("../php-scripts/handler/ajax/updateEmail.php", { email: emailValue, username: userLoggedIn})
...
function updatePassword(oldPasswordClass, newPasswordClass1, newPasswordClass2) {
    ...
    $.post("../php-scripts/handler/ajax/updatePassword.php",
...
function logout() {
    $.post("../php-scripts/handler/ajax/logout.php", function () {
        location.reload();
    });
}
